...
- **Agent Identifier (AgentID)**: A globally unique identifier for the agent
- **Agent Profile**: Contains public keys, services, and other identity information
...
H.I.V.E. supports multiple key types for agent authentication and message signing:

1. **Ed25519**: Modern elliptic curve cryptography offering superior performance and security
2. **RSA**: Traditional cryptography supporting various key sizes
3. **ECDSA**: Elliptic Curve Digital Signature Algorithm with P-256 curve support

All agent communications are signed using the appropriate key from the Agent Profile, ensuring
message authenticity while supporting various cryptographic standards.
...

{
  ...
  "profile": {
    ...
    "services": [{
      "id": "main",
      "type": "agent",
      "url": "https://agent-abc123.example.com/api"
    },{
      "id": "websocket",
      "type": "websocket",
      "url": "wss://agent-abc123.example.com/ws"
    }]
  },
  "capabilities": [
    {
