...
Each party is identified by their `did` (Decentralized Identifier) and a specific `verificationMethod` from their DID Document, which is used for message signing and verification. This approach provides greater flexibility and aligns with W3C standards for decentralized identity.
...
```json
{
  ...
  "requester": "did:hive:123456789abcdefghi",
  "provider": "did:hive:987654321jihgfedcba",
  "taskId": "task-456789",
