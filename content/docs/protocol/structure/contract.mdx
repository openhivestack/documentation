...
Each party is identified by their `agentId` and `publicKey`, which is used for message signing and verification.
...
```json
{
  ...
  "requester": "agent-abc123",
  "provider": "agent-xyz789",
  "taskId": "task-456789",
  ...
  "deadline": "2025-07-18T13:00:00Z",
  "requesterSignature": "Base64-encoded signature",
  "providerSignature": "Base64-encoded signature"
}
```
