...
description: The Protocol uses a 4-state task lifecycle that eliminates unnecessary complexity while maintaining clear task progression, perfect for high-throughput systems.
icon: LifeBuoy
---
...
<Callout type="warning">
  **Task Tracking**: maintain basic task state tracking to
