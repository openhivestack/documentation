...
- **No "IN_PROGRESS" state for Tier 1**: For simplicity, tasks go from `ACCEPTED` to `COMPLETED` or `FAILED`. Progress updates are a Tier 2 feature.
- **Removed "CANCELED"**: Tasks either complete or fail.
