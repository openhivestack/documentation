...
description: The Discovery Flow uses straightforward HTTP-based lookup that can handle millions of agents efficiently, instead of complex multi-step discovery protocols.
icon: Search
---
...
<Callout type="warning">
  **Registry Dependency**: Relies on registry availability. Implement
