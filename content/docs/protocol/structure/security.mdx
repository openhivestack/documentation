---
title: Security
description: The protocol provides essential security with focus on what's critical - message authentication and basic trust verification.
icon: ShieldCheck
---
...
<Callout type="info">
  **Security Philosophy**: provide essential security without complexity. Most
  agents don't need advanced trust models - just reliable message
  authentication.
</Callout>
